...
void sharpTurnLeft() {
  ...
  analogWrite(MOTOR_LEFT_BACKWARD, 0);
  analogWrite(MOTOR_RIGHT_FORWARD, BASE_SPEED + MAX_ADJUSTMENT); // Run the right motor at full speed
  analogWrite(MOTOR_RIGHT_BACKWARD, 0);
}

void sharpTurnRight() {
  analogWrite(MOTOR_LEFT_FORWARD, BASE_SPEED + MAX_ADJUSTMENT);  // Run the left motor at full speed
  analogWrite(MOTOR_LEFT_BACKWARD, 0);
